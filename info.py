...
support_chat_id = environ.get('SUPPORT_CHAT_ID', 'jsupportgroups') 
...
BAD_WORDS = ["PrivateMovieZ", "toonworld4all", "themoviesboss", "1tamilmv", "tamilblasters", "1tamilblasters", "skymovieshd", "extraflix", "hdm2", "moviesmod", "hdhub4u", "mkvcinemas", "primefix", "join", "www", "villa", "tg", "original", "CSZMovies", "Central_Links"] #Remove Words From File_Name
